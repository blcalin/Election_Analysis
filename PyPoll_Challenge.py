...
# CSV implements what to read and write in CSV format
import csv
# OS provides a way of using operating system function
import os
...
print(file_to_load, file_to_save)
...
with open(file_to_save, "w") as txt_file:
    ...
    for county in county_list:
        ...
        county_vote_percentage > largest_county_percentage
            ...
            # True
           largest_county_turnout_count = county_vote_percentage
